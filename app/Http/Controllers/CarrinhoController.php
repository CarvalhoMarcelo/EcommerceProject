...
class CarrinhoController extends Controller
{
    ...
    public function index(){
        ...
        $qtItens = $this->contaItens();

        return view('carrinho.index', compact('pedidos'))->with('qtItens',$qtItens);
    ...
    public function remover()
    {
        ...
        // Segurança para ter certeza que o ID do pedido pertence realmente ao usuario
        // e que o status esta correto para poder remover
        $idpedido = Pedido::consultaId([
            'id'      => $idpedido,
            'user_id' => $idusuario,
            'status'  => 'RE' // Reservada
    ...
    public function compras()
    {
        ...
        return view('carrinho.compras', compact('compras', 'cancelados'))->with('qtItens',$qtItens);
